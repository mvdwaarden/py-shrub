IT_RISKS_ISO_IEC_27001 = [
    ...
    [
        ...
        "Security aspects of human resources management, from pre-employment to termination.",
    ],
    ["Asset Management", "Responsibility for assets and information classification."],
    [
        "Access Control",
        "User access management, user responsibilities, and system and application access control.",
    ],
    ["Cryptography", "Encryption and key management for protecting information."],
    [
        "Physical and Environmental Security",
        "Protection of physical facilities and environments.",
    ],
    [
        "Operations Security",
    ...
    [
        ...
        "Security requirements, security in development and support processes, and test data.",
    ],
    [
...
IT_RISK_NIST = [
    ["Asset Management", "Identifying and managing assets and business environment."],
    [
    ...
    [
        "Risk Assessment",
        "Understanding cybersecurity risk to organizational operations, assets, and individuals.",
    ],
    ["Risk Management Strategy", "Processes to manage cybersecurity risk."],
    [
    ...
    ["Analysis", "Analysis of cybersecurity events."],
    ["Mitigation", "Mitigation of cybersecurity events."],
...
IT_RISK_COBIT = [
    ...
    [
        ...
        "Optimizing the realization of enterprise benefits through IT investments.",
    ],
    [
    ...
    [
        ...
        "Optimization of resource usage within the organization.",
    ],
    [
    ...
    [
        ...
        "Establishing and maintaining the IT management framework.",
    ],
    [
        "APO02 - Manage Strategy",
        "Defining and aligning IT strategy with business strategy.",
    ],
    [
        "APO03 - Manage Enterprise Architecture",
        "Aligning IT capabilities with business needs.",
    ],
    [
        "APO04 - Manage Innovation",
        "Managing the process of innovation within the IT domain.",
    ],
    [
        "APO05 - Manage Portfolio",
        "Management of IT investments and services portfolio.",
    ],
    [
    ...
    [
        ...
        "Management of relationships with business and external partners.",
    ],
    [
    ...
    [
        "APO12 - Manage Risk",
        "Identification, evaluation, and management of IT-related risks.",
    ],
    ["APO13 - Manage Security", "Management of IT security within the organization."],
    [
        "BAI01 - Manage Programs and Projects",
        "Management of programs and projects to achieve business objectives.",
    ],
    [
        "BAI02 - Manage Requirements Definition",
        "Management of requirements definition and prioritization.",
    ],
    [
        "BAI03 - Manage Solutions Identification and Build",
        "Identification and development of IT solutions.",
    ],
    [
    ...
    [
        ...
        "Management of acceptance and transitioning of changes.",
    ],
    [
        "BAI08 - Manage Knowledge",
        "Management of knowledge in IT processes and activities.",
    ],
    ...
    [
        ...
        "Management of business process controls and IT alignment.",
    ],
    [
...
IT_RISK_COSO = [
    [
        ...
        "Setting and maintaining an ethical tone at the top.",
    ],
    [
        "Entity's Risk Assessment",
        "Assessing risks facing the entity in the context of achieving its objectives.",
    ],
    [
        "Control Activities",
        "Actions taken to mitigate risks to the achievement of objectives.",
    ],
    [
    ...
    [
        ...
        "Evaluating the internal control system's performance over time.",
    ],
]
IT_RISK_ITIL = [
    [
...
IT_RISK_FAIR = [
    [
        "Risk Identification",
        "Identifying and documenting risk scenarios relevant to the organization.",
    ],
    [
        "Threat Analysis",
        "Analyzing and quantifying the frequency and magnitude of potential loss events.",
    ],
    [
    ...
    [
        "Risk Quantification",
        "Quantitatively estimating the frequency and magnitude of loss.",
    ],
    ["Control Analysis", "Analyzing the effectiveness of controls in reducing risk."],
]

IT_RISKS = {
    "ISO/IEC 27001": IT_RISKS_ISO_IEC_27001,
